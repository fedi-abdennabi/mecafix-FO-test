...
const FieldOptionsForm: FC<fieldOptionsFormProps> = ({isOpenOptionsForm, getDetails, id, isUpdatedInputLoading, setIsOpenOptions, updateInput }) => {
    ...
    const [options, setOptions] = useState<{ labal: string; value: string }[]>(detailsInput?.options || []);
                                                            ...
                                                            <Td>
                                                                ...
                                                                <Popover placement="right-end" >
                                                                    ...
                                                                    <PopoverContent>
                                                                        <PopoverArrow />
                                                                        <PopoverCloseButton />
                                                                        <PopoverHeader pb={2}>Confirmation!</PopoverHeader>
                                                                        <PopoverBody>
                                                                            <Formiz
                                                                            ...
                                                                            >
                                                                                <Stack spacing="2" alignItems="flex-start">
                                                                                    <Stack spacing="2">
                                                                                        <FieldInput size="sm" name="label" label="Label" required defaultValue={option?.label} />
                                                                                        <FieldInput size="sm" name="value" label="Value" required defaultValue={option?.value} />
                                                                                    </Stack>
